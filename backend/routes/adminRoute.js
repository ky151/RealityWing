...
router.route('/updateAdminProfile').post( isAuthenticatedAdmin,profileUpload.single('profile_image'),updateAdminProfile)
...
router.route('/editUser').post( isAuthenticatedAdmin,profileUpload.single('profile_image'),editUser)
...
router.route('/editCategory').post( isAuthenticatedAdmin,categoryUploads.single('category_image'),editCategory)
