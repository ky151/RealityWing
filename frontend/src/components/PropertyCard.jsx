...
const PropertyCard = ({ image, bhk, price, area, location, images }) => {
  return (
    <div className="bg-white rounded-xl shadow-sm border w-[300px] transition-shadow duration-300 hover:shadow-custom-lg cursor-pointer">
      ...
      <div className="p-3">
        ...
        <div className="text-lg font-bold text-gray-800 mt-1">
          ₹{price} <span className="font-medium text-sm">|</span> <span className="font-bold text-sm">{area} sqft</span>
        </div>
